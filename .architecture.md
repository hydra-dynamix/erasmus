...
.{IDE_ENV}rules # should be .windsurfrules or .cursorrules dynamical figured out by the SetupPaths object.
.architecture.md
.progress.md
.tasks.md
.erasmus/
.erasmus/cache
.erasmus/config
.erasmus/context/{CONTEXT_NAME}/
.erasmus/context/{CONTEXT_NAME}/.architecture.md
.erasmus/context/{CONTEXT_NAME}/.progress.md
.erasmus/context/{CONTEXT_NAME}/.tasks.md
.erasmus/logs
.erasmus/protocols/
.erasmus/protocols/agent_registry.json
.erasmus/protocols/stored/
.erasmus/protocols/stored/{PROTOCOL_NAME}.md
